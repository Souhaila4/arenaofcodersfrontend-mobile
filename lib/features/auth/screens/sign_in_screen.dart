  ...
  Future<void> _handleSignIn() async {
    ...
    try {
      ...
      if (e is SocketException) {
        detail = e.message ?? e.osError?.message ?? detail;
      }
      var msg =
          'Serveur injoignable ($base). $detail — Émulateur Android: essayez http://10.0.2.2:3000 ; téléphone: IP Wi‑Fi du PC (même réseau).';
