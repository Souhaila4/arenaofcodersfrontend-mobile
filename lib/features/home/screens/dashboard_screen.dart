...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          CustomScrollView(
            slivers: [
              ...
              SliverToBoxAdapter(
                child: Padding(
                  padding: const EdgeInsets.fromLTRB(20, 16, 20, 0),
                  child: _buildJobsCard(context, isDark),
                ),
              ),
              // Interview Prep Card (USER only)
              if (_currentUser?.role == 'USER')
                SliverToBoxAdapter(
                  child: Padding(
                    padding: const EdgeInsets.fromLTRB(20, 12, 20, 0),
                    child: _buildInterviewPrepCard(context, isDark),
                  ),
                ),
              // Invitations Section
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: const Color(0xFF00C2FF), // AppColors.primary equivalent from shell.dart
        elevation: 8,
  ...
  /// Card "Offres d'emploi" — navigates to the jobs listing screen.
  Widget _buildJobsCard(BuildContext context, bool isDark) {
    final isCompany = _currentUser?.role == 'COMPANY';
    return Material(
      color: isDark ? const Color(0xFF151B26) : Colors.grey.shade100,
      borderRadius: BorderRadius.circular(16),
      child: InkWell(
        borderRadius: BorderRadius.circular(16),
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute<void>(builder: (_) => const JobsScreen()),
          );
        },
        child: Padding(
          ...
          child: Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFF7C3AED).withAlpha(isDark ? 40 : 28),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      isCompany
                          ? 'Publiez des offres et lancez le matching IA pour trouver les meilleurs talents.'
                          : 'Découvrez les offres d\'emploi publiées par les entreprises.',
                      style: TextStyle(
                        fontSize: 13,
                        height: 1.35,
                        color: Colors.grey.shade500,
  ...
  /// Card "Interview prep" — navigates to the jobs listing where USERs can
  /// pick a job and start a mock interview with the AI recruiter.
  Widget _buildInterviewPrepCard(BuildContext context, bool isDark) {
    return Material(
      color: isDark ? const Color(0xFF151B26) : Colors.grey.shade100,
      borderRadius: BorderRadius.circular(16),
      child: InkWell(
          ...
          child: Row(
            children: [
              Container(
                padding: const EdgeInsets.all(12),
                decoration: BoxDecoration(
                  color: AppColors.primary.withAlpha(isDark ? 40 : 28),
                  borderRadius: BorderRadius.circular(12),
                ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      'Choisissez une offre et simulez un entretien avec un recruteur IA.',
                      style: TextStyle(
                        fontSize: 13,
                        height: 1.35,
                        color: Colors.grey.shade500,
