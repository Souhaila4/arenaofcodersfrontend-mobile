    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Each checkpoint opens at a set time and stays open for 15 minutes. Submit during that window to stay in the competition.',
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Opens at ${_formatDateTime(sub.checkpoint.opensAt)}',
