          ...
          if (isLeader && status.toUpperCase() == 'FORMING') ...[
            ...
            if (members.length >= 4)
              ...
              Container(
                ...
                child: const Text('Il faut au minimum 4 membres (leader inclus) pour être prêt', 
                  textAlign: TextAlign.center, 
          ...
          if (_loadingCheckpoints) ...[
            ...
            Center(
              child: Padding(
                padding: const EdgeInsets.all(16),
                child: Text(
                  'Aucun checkpoint pour le moment',
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Vous devez obligatoirement former une équipe complète (4 membres minimum) et la marquer comme prête pour débloquer la validation.',
