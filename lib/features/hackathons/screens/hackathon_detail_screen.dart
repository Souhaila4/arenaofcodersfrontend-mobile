                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    // Hide join/submit for Admin and Company roles
                                    if (_user?.role == 'USER') ...[
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    (_antiCheatScore != null && (double.tryParse(_antiCheatScore!.replaceAll('%', '')) ?? 0) >= (_competition!.antiCheatThreshold ?? 70))
                        ? 'Votre code a été détecté comme généré par IA au-delà du seuil autorisé. Vous ne pouvez plus soumettre.'
                        : 'Vous avez été éliminé car vous n\'avez pas validé vos checkpoints (3 échecs ou plus) ou n\'avez pas soumis votre code final à temps.',
                    textAlign: TextAlign.center,
