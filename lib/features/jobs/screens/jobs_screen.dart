...
import 'package:arena/features/jobs/screens/favorite_talents_screen.dart';
        ...
        actions: [
          if (_isCompany) ...[
            IconButton(
              ...
              tooltip: 'Mes Talents Favoris',
              onPressed: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (_) => const FavoriteTalentsScreen(),
                  ),
                );
              },
            ),
  ...
  Widget _buildJobCard(JobPosting job, bool isDark) {
    ...
    return Material(
      ...
      child: InkWell(
        ...
        onTap: () {
          if (_isCompany) {
            // Les entreprises voient d'abord le détail de l'offre
            Navigator.of(context).push(
