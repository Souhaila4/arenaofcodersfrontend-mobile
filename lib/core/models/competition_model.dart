...
class Competition {
  ...
  factory Competition.fromJson(Map<String, dynamic> json) {
    ...
    return Competition(
      ...
      startDate: startRaw != null ? DateTime.parse(startRaw.toString()).toLocal() : DateTime.now(),
      endDate: endRaw != null ? DateTime.parse(endRaw.toString()).toLocal() : DateTime.now(),
...
class CompetitionCheckpoint {
  ...
  factory CompetitionCheckpoint.fromJson(Map<String, dynamic> json) {
    ...
    return CompetitionCheckpoint(
      ...
      dueDate: dueRaw != null ? DateTime.parse(dueRaw.toString()).toLocal() : DateTime.now(),
      isMandatory: json['isMandatory'] as bool? ?? true,
      createdAt: createdRaw != null ? DateTime.parse(createdRaw.toString()).toLocal() : DateTime.now(),
    );
  }
}
...
class CheckpointSubmissionWithCheckpoint {
  ...
  final String? participantId; // Metadata: who submitted (optional)
  final String? equipeId;      // Main identifier for team-aware submissions
  ...
  factory CheckpointSubmissionWithCheckpoint.fromJson(Map<String, dynamic> json) {
    ...
    return CheckpointSubmissionWithCheckpoint(
      ...
      submittedAt: json['submittedAt'] != null ? DateTime.parse(json['submittedAt'].toString()).toLocal() : null,
      reviewedAt: json['reviewedAt'] != null ? DateTime.parse(json['reviewedAt'].toString()).toLocal() : null,
