...
import 'accessibility_voice.dart';
class AccessibilityProvider extends ChangeNotifier {
  ...
  Future<void> setTalkToAppEnabled(bool enabled, [BuildContext? context]) async {
    ...
    if (enabled && context != null) {
      ...
      AccessibilityVoice().startListeningForCommands(context, this);
    } else if (!enabled) {
      AccessibilityVoice().stopListeningForCommands();
    }
  }
